...
import { BarChart3, AlertTriangle, Banknote, CalendarDays } from 'lucide-react'
...
export default function Reports() {
  ...
  const reportCards = [
    ...
    { id: 'collection' as ReportType, title: 'Collection Report', desc: 'Payments received this month', icon: Banknote, color: 'text-emerald-600' },
    { id: 'emi' as ReportType, title: 'EMI Due Report', desc: 'Upcoming EMI schedules', icon: CalendarDays, color: 'text-amber-600' },
  ]
